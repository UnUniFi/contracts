use cosmwasm_std::{from_slice, to_binary, Binary, Coin, CosmosMsg, Empty, QueryRequest, IbcMsg, Uint128, Decimal};
use schemars::JsonSchema;
// use serde::de::DeserializeOwned;
use serde::{Deserialize, Serialize};
use crate::state::{Phase, ChannelInfo};

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
#[serde(rename_all = "snake_case")]
pub enum AllOriginalPacketMsg {
    OriginalMsg(ExecuteMsg),
    IbcMsg(IbcMsg)
}
